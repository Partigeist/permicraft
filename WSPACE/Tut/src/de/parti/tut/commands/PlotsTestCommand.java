		...
		if(sender instanceof Player) {
			...
			if(args.length > 0) {
				...
				case "zoc"://Z-Koordinate des Chunks
					...
					break;
				case "pon"://Plotname der benachbarten Chunks, falls sie zu einem Plot gehören
					...
					break;
				default:
					p.sendMessage("Bitte nutze /gstest coplot <plotname>;ocl;list;coplayer;poc;zoc;pon");
					break;
				}
			} else
